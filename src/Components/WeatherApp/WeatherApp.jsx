...
export const WeatherApp = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="weather-image" style={{padding : "20px 20px"}}>
        <img src={wicon} alt="" />
      </div>
      <div className="weather-temp" style={{padding : "20px 20px"}}>{temperature}</div>
      <div className="weather-location" style={{padding : "20px 20px"}}>{location}</div>
      </div>
